...
func TestHealthEndpoint(t *testing.T) {
	...
	srv := New(cfg, auth.NewHandler(nil), user.NewHandler(nil, cfg, nil, nil), nil, jwtMgr, nil, nil, nil, nil, admin.NewHandler(nil, nil, 0, admin.RuntimeConfigFrom(cfg)), nil, nil, nil, nil)
